...
export interface Course {
  ...
  level?: string;
  category?: string;
  minimumMeanGrade?: string; // Minimum mean grade required for the course
}
...
const cluster3Courses: Course[] = [
  { name: "Bachelor of Education (Arts)", code: "1263200", universities: ["University of Nairobi"], previousYearCutoff: 32.500, bestCluster: 3, clusters: [3], subjectRequirements: { english: "C+", kiswahili: "C+" }, minimumMeanGrade: "C+" },
  { name: "Bachelor of Education (Arts)", code: "1111200", universities: ["Kenyatta University"], previousYearCutoff: 31.200, bestCluster: 3, clusters: [3], subjectRequirements: { english: "C+", kiswahili: "C" }, minimumMeanGrade: "C+" },
  { name: "Bachelor of Education (Arts)", code: "1253200", universities: ["Moi University"], previousYearCutoff: 30.800, bestCluster: 3, clusters: [3], subjectRequirements: { english: "C+", history: "C" }, minimumMeanGrade: "C+" },
...
const cluster5Courses: Course[] = [
  { name: "Bachelor of Medicine and Surgery (MBChB)", code: "1263001", universities: ["University of Nairobi"], previousYearCutoff: 46.500, bestCluster: 5, clusters: [5], subjectRequirements: { english: "B", biology: "A-", chemistry: "A-", mathematics: "B+" }, minimumMeanGrade: "A-" },
...
const cluster13Courses: Course[] = [
  { name: "Bachelor of Arts in Sociology", code: "1263101", universities: ["University of Nairobi"], previousYearCutoff: 28.500, bestCluster: 13, clusters: [13], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C+" },
  ...
  { name: "Bachelor of Social Work", code: "1111103", universities: ["Kenyatta University"], previousYearCutoff: 27.800, bestCluster: 13, clusters: [13], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C+" },
...
const cluster16Courses: Course[] = [
  ...
  { name: "Bachelor of Arts in Theatre Arts", code: "1263140", universities: ["University of Nairobi"], previousYearCutoff: 24.800, bestCluster: 16, clusters: [16], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C" },
...
const cluster17Courses: Course[] = [
  ...
  { name: "Bachelor of Hospitality & Tourism", code: "1111150", universities: ["Kenyatta University"], previousYearCutoff: 27.200, bestCluster: 17, clusters: [17], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C+" },
...
const cluster18Courses: Course[] = [
  ...
  { name: "Bachelor of Security Management", code: "1111160", universities: ["Kenyatta University"], previousYearCutoff: 28.200, bestCluster: 18, clusters: [18], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C+" },
...
const cluster19Courses: Course[] = [
  ...
  { name: "Bachelor of Physical Education", code: "1253170", universities: ["Moi University"], previousYearCutoff: 25.200, bestCluster: 19, clusters: [19], subjectRequirements: { english: "C" }, minimumMeanGrade: "C" },
...
const cluster20Courses: Course[] = [
  { name: "Bachelor of Education (Special Needs)", code: "1111180", universities: ["Kenyatta University"], previousYearCutoff: 28.500, bestCluster: 20, clusters: [20], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C+" },
  ...
  { name: "Bachelor of Sign Language Interpretation", code: "1229180", universities: ["Maseno University"], previousYearCutoff: 25.800, bestCluster: 20, clusters: [20], subjectRequirements: { english: "C+" }, minimumMeanGrade: "C" },
];

// Artisan Courses (Level 4)
const artisanCourses: Course[] = [
  { name: "Artisan in Masonry", code: "ART001", universities: ["Nairobi Technical", "Mombasa Technical", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Building, Construction & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Plumbing", code: "ART002", universities: ["Kenya Polytechnic", "Kisumu Polytechnic", "Thika Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Building, Construction & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Welding and Fabrication", code: "ART003", universities: ["Mombasa Technical", "Nairobi Technical", "Kabete National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Engineering & Technology & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Motor Vehicle Mechanics", code: "ART004", universities: ["Kenya Polytechnic", "Kisii National Polytechnic", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Engineering & Technology & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Electrical Installation", code: "ART005", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Nairobi Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Engineering & Technology & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Carpentry and Joinery", code: "ART006", universities: ["Kisumu Polytechnic", "Machakos Technical", "Nyeri National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Building, Construction & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Tailoring", code: "ART007", universities: ["Nairobi Technical", "Mombasa Technical", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Clothing, Fashion & Textile", minimumMeanGrade: "E" },
  { name: "Artisan in Hairdressing", code: "ART008", universities: ["Nairobi Technical", "Mombasa Technical", "Kisumu Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Hair Dressing & Beauty Therapy", minimumMeanGrade: "E" },
  { name: "Artisan in Beauty Therapy", code: "ART009", universities: ["Kenya Polytechnic", "Eldoret Polytechnic", "Nyeri National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Hair Dressing & Beauty Therapy", minimumMeanGrade: "E" },
  { name: "Artisan in Food Processing", code: "ART010", universities: ["Mombasa Polytechnic", "Kisii National Polytechnic", "Nairobi Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Food Science & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Painting and Decoration", code: "ART011", universities: ["Kenya Polytechnic", "Eldoret Polytechnic", "Machakos Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Building, Construction & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Leather Work", code: "ART012", universities: ["Nairobi Technical", "Kisumu Polytechnic", "Thika Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Clothing, Fashion & Textile", minimumMeanGrade: "E" },
  { name: "Artisan in Refrigeration and Air Conditioning", code: "ART013", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Engineering & Technology & Related", minimumMeanGrade: "E" },
  { name: "Artisan in Agricultural Mechanics", code: "ART014", universities: ["Bukura Agricultural College", "Egerton University", "Kisii National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "Agricultural Sciences & Related", minimumMeanGrade: "E" },
  { name: "Artisan in ICT Support", code: "ART015", universities: ["Kenya Polytechnic", "Nairobi Technical", "Mombasa Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "E" }, level: "Artisan", category: "IT & Related", minimumMeanGrade: "E" },
];

// Certificate Courses (Level 5)
const certificateCourses: Course[] = [
  { name: "Certificate in Business Administration", code: "CERT001", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D+", mathematics: "D+" }, level: "Certificate", category: "Business & Related", minimumMeanGrade: "D" },
  { name: "Certificate in Information Technology", code: "CERT002", universities: ["Nairobi Technical", "Kisumu Polytechnic", "Nyeri National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D+", mathematics: "D+" }, level: "Certificate", category: "IT & Related", minimumMeanGrade: "D" },
  { name: "Certificate in Accounting", code: "CERT003", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Thika Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D+", mathematics: "D" }, level: "Certificate", category: "Business & Related", minimumMeanGrade: "D" },
  { name: "Certificate in Sales and Marketing", code: "CERT004", universities: ["Eldoret Polytechnic", "Kisii National Polytechnic", "Machakos Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D+", kiswahili: "D+" }, level: "Certificate", category: "Business & Related", minimumMeanGrade: "D" },
  { name: "Certificate in Food and Beverage", code: "CERT005", universities: ["Kenya Utalii College", "Mombasa Polytechnic", "Nairobi Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D" }, level: "Certificate", category: "Hospitality, Hotel, Tourism, & Related", minimumMeanGrade: "D-" },
  ...
  { name: "Certificate in Plumbing", code: "CERT007", universities: ["Nairobi Technical", "Mombasa Technical", "Machakos Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D" }, level: "Certificate", category: "Building, Construction & Related", minimumMeanGrade: "D-" },
  { name: "Certificate in Fashion Design", code: "CERT008", universities: ["Kenya Polytechnic", "Eldoret Polytechnic", "Nyeri National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D+", art: "D" }, level: "Certificate", category: "Clothing, Fashion & Textile", minimumMeanGrade: "D" },
  ...
  { name: "Certificate in Building Technology", code: "CERT010", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Kisumu Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "D", mathematics: "D" }, level: "Certificate", category: "Building, Construction & Related", minimumMeanGrade: "D" },
];

// Diploma Courses (Level 6)
const diplomaCourses: Course[] = [
  { name: "Diploma in Business Management", code: "DIP001", universities: ["Kenya Polytechnic", "Mombasa Polytechnic", "Eldoret Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-", mathematics: "C-" }, level: "Diploma", category: "Business & Related", minimumMeanGrade: "C-" },
  ...
  { name: "Diploma in Accounting", code: "DIP003", universities: ["Mombasa Polytechnic", "Kenya Polytechnic", "Kisii National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-", mathematics: "C-" }, level: "Diploma", category: "Business & Related", minimumMeanGrade: "C-" },
  { name: "Diploma in Human Resource Management", code: "DIP004", universities: ["Kenya Polytechnic", "Eldoret Polytechnic", "Thika Technical"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-" }, level: "Diploma", category: "Business & Related", minimumMeanGrade: "C-" },
  { name: "Diploma in Supply Chain Management", code: "DIP005", universities: ["Mombasa Polytechnic", "Kenya Polytechnic", "Kisumu Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-", mathematics: "D+" }, level: "Diploma", category: "Business & Related", minimumMeanGrade: "C-" },
  { name: "Diploma in Hospitality Management", code: "DIP006", universities: ["Kenya Utalii College", "Mombasa Polytechnic", "Kenya Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-" }, level: "Diploma", category: "Hospitality, Hotel, Tourism, & Related", minimumMeanGrade: "C-" },
  ...
  { name: "Diploma in Social Work", code: "DIP009", universities: ["Kenya Institute of Social Work", "Nairobi Technical", "Kisii National Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-" }, level: "Diploma", category: "Social Sciences", minimumMeanGrade: "C-" },
  ...
  { name: "Diploma in Education", code: "DIP011", universities: ["Kenya Teachers Training College", "Machakos TTC", "Migori TTC"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-" }, level: "Diploma", category: "Education & Related", minimumMeanGrade: "C-" },
  ...
  { name: "Diploma in Law", code: "DIP013", universities: ["Kenya School of Law", "Mombasa Polytechnic"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C" }, level: "Diploma", category: "Law", minimumMeanGrade: "C" },
];
...
const kmtcCourses: Course[] = [
  ...
  { name: "Diploma in Kenya Registered Community Health Nursing", code: "KMTC002", universities: ["KMTC"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C", biology: "C-", chemistry: "D+" }, level: "KMTC", minimumMeanGrade: "C-" },
  ...
  { name: "Diploma in Radiography", code: "KMTC005", universities: ["KMTC"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C", biology: "C-", physics: "C-" }, level: "KMTC", minimumMeanGrade: "C" },
  ...
  { name: "Diploma in Nutrition and Dietetics", code: "KMTC007", universities: ["KMTC"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-", biology: "C-", chemistry: "D+" }, level: "KMTC", minimumMeanGrade: "C-" },
  { name: "Diploma in Health Records", code: "KMTC008", universities: ["KMTC"], previousYearCutoff: 0, bestCluster: 0, clusters: [], subjectRequirements: { english: "C-", mathematics: "D+" }, level: "KMTC", minimumMeanGrade: "C-" },
